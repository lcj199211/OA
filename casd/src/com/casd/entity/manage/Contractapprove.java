...
public class Contractapprove implements Serializable {
	...
	private static final long serialVersionUID = -1359978093791375770L;
		...
		private int manage_contractapprove_id; 					//合同id 
		...
		public int getManage_contractapprove_id() {
			return manage_contractapprove_id;
		}
		public void setManage_contractapprove_id(int manage_contractapprove_id) {
