...
<body class="easyui-layout" style="overflow-y: hidden;" scroll="no">
	...
	<script type="text/javascript">
		function operate_formatter(value, row, index) {
			...
			html += '<a href="javascript:;" class="opt"    cmd="aPartyMaterialList" i="' + index + '">甲方材清单</a>';
			
			html += '<a href="javascript:;" class="opt"    cmd="aPartyPurList" i="' + index + '">申请采购</a>';
		...
		function cmdHanlder(cmd, row) {
			if (cmd == "aPartyMaterialList") {
				
				location.href = "aPartyMaterialList.do?" + $.param({
					'construct_project_id' : row.construct_project_id
				});
			}else{
