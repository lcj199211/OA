	...
	<div>
		<form action="" id="ownhead">
					...
					<div class="fieldset-body">
						<table class="form-table" border="0" cellpadding="5"
							...
							<tr>
								...
								<td style="width:150px"><input type="text"
									value="${own_purchase_planMan==null?loginUser.username:own_purchase_planMan}" name="own_purchase_planMan"
									id="own_purchase_planMan" class="mini-textbox" readonly="readonly"/></td>
							</tr>
						<tr>
			...
			<div id="audit">
				...
				<div id="tb" style="height:auto">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton"
						data-options="iconCls:'icon-undo',plain:true" onclick="removeit()">撤销新增行</a>
				</div>
				<!-- 打开子框开始 -->
		...
		<div style="margin:20px 0;">		
			 <table id="history" class="easyui-datagrid" title="审批记录"
					style="width:1200px;height:aotu"
					data-options="
						iconCls: 'icon-edit',
						singleSelect: true,">
					<thead>
