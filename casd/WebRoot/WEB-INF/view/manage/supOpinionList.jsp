			...
			<div class="easyui-layout" fit="true">
				...
				<div region="center" split="false" border="false"
					...
					<table id="data" title="" fit="true"
						...
						<thead>
							<tr>
								<th halign="center" field="supOpinion_id" align="center"  hidden="hidden"
									sortable="true" width="60px">单据id</th>
								<th  halign="center" field="supOpinion_company" align="center"
									sortable="true" width="60px">被监察公司</th>
								<th halign="center" field="supOpinion_title" align="center"
									sortable="true" width="120px">月份</th>
								<th halign="center" field="supOpinion_creatDate" align="center" 
 ...
 */
		...
		function cmdHanlder(cmd, row) {
			if (cmd == "view") {
				location.href = "supOpinionView.do?bizId="+row.supOpinion_id+"";
