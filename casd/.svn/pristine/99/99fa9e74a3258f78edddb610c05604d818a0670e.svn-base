...
/**
 *    采购材料分录 construct_purchase_entry_class
 * */
public class PurchaseEntryClass implements Serializable{
	...
	private String construct_purchase_suppliers;		//供应商
	private int construct_purchase_arriveNum;			//到货数量
	private int construct_purchase_noArrive;			//未到货数量
	...
	public String getConstruct_purchase_suppliers() {
		return construct_purchase_suppliers;
	}
	public void setConstruct_purchase_suppliers(
			String construct_purchase_suppliers) {
		this.construct_purchase_suppliers = construct_purchase_suppliers;
	}
	public int getConstruct_purchase_arriveNum() {
		return construct_purchase_arriveNum;
	}
	public void setConstruct_purchase_arriveNum(int construct_purchase_arriveNum) {
		this.construct_purchase_arriveNum = construct_purchase_arriveNum;
	}
	public int getConstruct_purchase_noArrive() {
		return construct_purchase_noArrive;
	}
	public void setConstruct_purchase_noArrive(int construct_purchase_noArrive) {
		this.construct_purchase_noArrive = construct_purchase_noArrive;
	}
