...
<body class="easyui-layout" style="overflow-y: hidden;" scroll="no">
			...
			<div class="easyui-layout" fit="true">
				...
				<div class="easyui-panel" title="查询条件" style="margin-bottom: 5px;">
					...
					<div class="search">
						<ul>
							...
							<li><label>年度：</label>
							<select  id="yearMon" name="yearMon"  style="width:100px;">
						...
						<div >
							<ul>
								...
								<li> <a href="#" class="easyui-linkbutton"
									 onclick="btnReport();">收款报表</a></li>
							
								<%-- <li style=" float:right"> <b >统计：${sum}元</b></li> --%>
							</ul>
				...
				<div region="center" split="false" border="false"
					...
					<table id="data" title="" fit="true"
						data-options="collapsible: true,pagination:true,rownumbers:true,onDblClickRow:onDblClickRow,showFooter:true,onDblClickCell:onDblClickCell">
						<thead>
							<tr>
								...
								<th halign="center" field="manage_contract_address" align="center" 
									sortable="true" width="230px" >项目地址</th>
								...
								<th halign="center" field="gatherAmount" align="right" 
									sortable="true" width="120px" >收款总金额</th>
								<th halign="center" field="noGatherAmount" align="right" 
									sortable="true" width="120px" formatter="noGatherAmount_formatter" >未收款金额</th>		
	...
	<script type="text/javascript">
		...
		function noGatherAmount_formatter(value, row, index) {
	 		return (parseFloat(totalAmount(value, row, index)==null?"0":totalAmount(value, row, index)) - parseFloat(row.gatherAmount==null?"0":row.gatherAmount)).toFixed(2);
		...
		function onDblClickCell(index,field,value){
			if(field=="manage_contract_name"){
				var row = $('#data').datagrid("selectRow", index).datagrid("getSelected");
				location.href = "contractNew.do?manage_contract_id="+row.manage_contract_id+"&type='view'";
			}
		}
