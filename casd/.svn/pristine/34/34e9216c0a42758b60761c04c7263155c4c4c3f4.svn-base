					...
					<table id="data" title="" fit="true"
						...
						<thead>
							<tr>
								...
								<th halign="center" field="construct_project_workTeam_category" align="center" formatter="category"
									sortable="true" width="220px">施工项目</th>
								
								<th halign="center" field="construct_project_workTeam_id" align="center"
									sortable="true" width="220px">施工项目编号</th>
									
								<th halign="center" field="username" align="center"
									sortable="true" width="220px">班组</th>	
