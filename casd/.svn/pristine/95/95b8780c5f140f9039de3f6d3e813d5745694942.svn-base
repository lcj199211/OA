			...
			<div class="easyui-layout" fit="true">
				<div region="north" split="false" border="false"
					...
					<div class="easyui-panel" title="操作" style="margin-bottom: 5px;">
						...
						<div class="search">
							...
							<li><label> 公司：</label> <select id="constuct_project_dep_company" name="constuct_project_dep_company"
							...
							<li><label>项目：</label><input type="text" name="construct_project_name" id="construct_project_name"
				...
				<div region="center" split="false" border="false"
					...
					<table id="data" title="" fit="true"
						data-options="collapsible: true,pagination:true,showFooter:true">

						<thead>
							<tr>
								<th halign="center" field="construct_purchase_id" align="center" sortable="true"
									width="120px">编号</th>
								<th halign="center" field=constuct_project_dep_company align="center" sortable="true"formatter="company_formatter"
									width="120px">公司</th>
								...
								<th halign="center" field="construct_project_leader" align="center" sortable="true"
									width="120px">项目经理</th>
								<th halign="center" field="construct_purchase_supplier" align="center" sortable="true"
									width="200px">供应商</th>			
								<th halign="center" field="construct_purchase_materialSerName" align="center" sortable="true"
									width="120px">采购分类</th>
								<th halign="center" field="total" align="center" sortable="true"
									width="120px">采购合计</th>	
