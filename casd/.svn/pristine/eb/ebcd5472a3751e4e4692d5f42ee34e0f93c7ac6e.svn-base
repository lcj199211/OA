...
<div style="float:left;width:60%;" >
	...
	<table id="materialListID" class="easyui-datagrid" title="请款进度"
		...
		data-options="
				iconCls: 'icon-edit',
				singleSelect: true,
				toolbar: '#tb',onClickCell:onClickCell,rownumbers:true,showFooter: true
				">
		<thead>
			<tr>
				<th 
				...
				<th
					data-options="field:'manage_reqfunds_time',width:100,align:'center',editor:'datebox'">请款时间</th>
				<th
					data-options="field:'manage_reqfunds_amount',width:140,align:'center',editor:'text' ">请款金额</th>
				<th
					data-options="field:'manage_reqfunds_ticketDate',width:100,align:'center',editor:'datebox'">开票日期</th>
				<th
					data-options="field:'manage_reqfunds_ticketAmount',width:140,align:'center',editor:'text' ">开票金额</th>
				<th
					data-options="field:'manage_reqfunds_receiveDate',width:100,align:'center',editor:'datebox'">收款日期</th>
				<th
					data-options="field:'manage_reqfunds_receiveAmount',width:140,align:'center',editor:'text' ">收款金额</th>
				<th
					data-options="field:'manage_reqfunds_remark',width:140,align:'center' ,editor:'text' ">备注</th>
			</tr>
		</thead>
