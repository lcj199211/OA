...
<body class="easyui-layout" style="overflow-y: hidden;" scroll="no">
					...
					<div class="easyui-panel" title="查询条件" style="margin-bottom: 5px;">
						...
						<div class="search">
							<ul>
								...
								<li>&nbsp;&nbsp; <a class="easyui-linkbutton"
									data-options="iconCls:'icon-mini_edit'" href="javascript:;"
									onclick="btnArrived()">到货情况</a></li>	
							</ul>
							<div class="clear"></div>
						</div>
					</div>
	...
	<script type="text/javascript">
		...
		function cmdHanlder(cmd, row) {
			if (cmd == "view") {
				...
				location.href = "finalPurchaseView.do?" + $.param({
					...
					'purchase_status' : row.construct_purchase_status, 
				});
		...
		function btnArrived(){
			...
			location.href ="arrivePurchaseList.do?construct_purchase_id="+rows[0].construct_purchase_id+"";
